...
public class SchoolController {
    ...
    @GetMapping
    public String showSchoolListPage(Model model, @ModelAttribute("message") String message, //model to send data to database from java
    ...
    //GET TO SHOW THE PAGE, POST TO DO OPERATION
    @GetMapping("/update/{id}")
    public String showUpdateSchoolPage(@PathVariable Long id,
